...
void imprime(GRAFO* gr){
    ...
    GRAFO* gr = inicializa_grafo(6);
     imprime(gr);
     	cout <<endl<< "APOS INSERIR TEMOS: ";
   inserir_aresta(gr,1,3);
   inserir_aresta(gr,1,4);
   inserir_aresta(gr,1,5);
   inserir_aresta(gr,2,3);
   inserir_aresta(gr,2,4);
   inserir_aresta(gr,2,5);
   inserir_aresta(gr,3,5);
   inserir_aresta(gr,4,5);
